                    ...
                    <div className='px-10 py-8 mt-10 shadow-lg shadow-blue-300 w-[90%] ml-[5%] rounded-xl'>
                        ...
                        <form role="form" onSubmit={handleSubmit}>
                            ...
                            <div className='mt-3 mb-3'>
                                <Link to='/ForgetPassword' className='text-blue-500 text-[16px] font-semibold'>Forget password?</Link>.
                            </div>
                            <button type="submit" className="w-full bg-blue-400 text-white py-2" id="registration_submit">Login</button>
                            <p className='text-center mt-3'>New to Internshala? Register<Link to="/StudentSignup" className='text-blue-500'> (Student)</Link></p>
                        </form>
                    </div>
                </div>
            </div>
