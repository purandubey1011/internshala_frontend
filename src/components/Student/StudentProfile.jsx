    ...
    <div>
      <div className='w-full py-4 shadow flex px-14 items-center justify-between'>
        ...
        <div className='flex items-center gap-10 text-[16px]'>
          ...
          <Link to={'/resume'} className='hover:text-blue-400 cursor-pointer'>Add Resume<i className="ri-arrow-down-s-fill"></i></Link >
      ...
      <div className='w-full h-screen  p-10'>
        <h1 className='text-[2.2vw] font-semibold text-center'>Hi, {user.firstname}! ✋</h1>
      ...
      <motion.aside
        ...
        <div className='w-20 h-20 rounded-full bg-blue-300 ml-[65px] mb-2 border overflow-hidden'>
        <img className='w-full h-full object-cover' src={user.avatar != '' ? user.avatar : 'https://cdn-icons-png.flaticon.com/512/149/149071.png'} alt="" />
        </div>
        <p className='font-bold'>{user.firstname} {user.lastname}</p>
        <p>{user.email}</p>
        <div className='w-full h-[2px] mt-3 bg-zinc-300 mb-5'></div>
        <div className='w-full flex flex-col ml-5 gap-2'>
