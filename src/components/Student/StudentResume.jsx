...
import { asyncremoveuser, asyncresumecreate , asynccurrentuser } from '../../store/Actions/userActions'
const ResumeForm = () => {
    ...
    //     updatedFormData.education[0].college = event.target.value;
    //     updatedFormData.education[0].degree= event.target.value;
    //     setFormData(updatedFormData);
    //   };

    //   const handleDegreeChange = (event) => {
    //     const updatedForm = { ...formData };
    //     updatedForm.education[0].degree= event.target.value;
    ...
    const handleSubmit = (event) => {
        ...
        dispatch(asyncresumecreate(formData))
    };
    ...
    return user ? (
        <>
            ...
            <div className="max-w-3xl mx-auto my-8">
                <h2 className="text-4xl font-bold text-center">Resume Form</h2>
            </div>
            ...
            <div className='w-[60vw] min-h-[200vh] m-auto p-8'>
                <form action="" onSubmit={handleSubmit}>
                    ...
                    <button className='px-4 font-semibold text-white rounded py-2 bg-blue-500'>Create</button>
                </form>
            </div>
